...
class MessageService {
    ...
    async sendTemplateMessage(request: SendTemplateRequest, projectId: string): Promise<SendTemplateResponse> {
        ...
        const insertData: WhatsAppMessageInsert = {
            ...
            templateName: request.templateName,
            language: request.language,
            header: request.header as unknown as Record<string, unknown> | null,
            body: request.body as unknown as Record<string, unknown> | null,
            button: request.button as unknown as Record<string, unknown>[] | null,
            payload,
            provider: 'telinfy',
